...
class PythonTokenizer(cubert_tokenizer.CuBertTokenizer):
    ...
    def tokenize_and_abstract(
        ...
        for token_tuple in token_tuples:
            ...
            # we'll adjust the spellingg of some tokens, e.g., those that we
            ...
            if kind == tokenize.NAME:
                ...
                if kind in PythonTokenizer._TOKEN_TYPE_TO_TOKENIZE_BY_TYPE:
                ...
                try:
                    ...
                    # rely on knowning which they are. We'll check by spelling.
    ...
    def untokenize_abstract(self, whole_tokens):
        ...
        for whole_token in whole_tokens:
            ...
            elif PythonTokenizer._TRIPLE_STRINGS_BEGINNINGS.match(whole_token):
                token_tuples.append((tokenize.STRING, whole_token))
