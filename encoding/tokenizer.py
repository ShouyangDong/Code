...
class CuBertTokenizer(abc.ABC):
    ...
    def __init__(self, max_output_token_length=MAX_OUTPUT_TOKEN_LENGTH, reserved=()):
        self.types_to_skip = ()
        ...
        self.update_mappings(
            {
                ...
                "\r": unified_tokenizer.quote_special("CR"),
                unified_tokenizer.SENTINEL: unified_tokenizer.quote_special(
                    unified_tokenizer.SENTINEL_ESCAPE
                ),
            }
        )
    ...
    def update_types_to_skip(self, types_to_skip):
    ...
    def condition_full_tokens(self, agnostic):
        ...
        with_reserved: Sequence[unified_tokenizer.AbstractToken] = tuple(
            ...
            if a.spelling in self.reserved
            else a
            for a in filtered
        )
        return with_reserved

    def subtokenize_full_tokens(self, agnostic):
    ...
    def tokenize(self, source_code):
        ...
        try:
            ...
            raise ValueError(
                "While trying to do language-specific tokenization for "
                "the string:\n\n\n%r\n\n\n%s\n\n\n"
